...
(async () => {
  ...
  await page.goto('https://merchant.grab.com/en-my/blog', { waitUntil: 'load', timeout: 45000 });
  await page.waitForTimeout(2000);
  console.log('URL:', page.url());
  console.log('Title:', await page.title());
  await page.screenshot({ path: `${OUT}/blog_listing.png`, fullPage: true });
  const html = await page.content();
  require('fs').writeFileSync(`${OUT}/blog_listing.html`, html);
